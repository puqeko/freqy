...
#define timer_pwm_frequency(prescaler) (F_CPU / (prescaler * 510.0))
...
// Any decent compiler will optimise out the if else blocks since they will allways evavluate
// to the same result based on the mode and timer.
